    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-3xl font-bold">
                <span class="text-yellow-400">Welcome</span> <span class="text-cyan-400">back</span>
            </h2>
            <p class="text-gray-400 mt-2">Sign in to keep exploring activities around you</p>
        </div>
        ...
        <div class="relative p-8 glass-card">
            ...
            @if ($errors->has('social'))
                <div class="mb-6 p-4 rounded-xl bg-red-500/20 border border-red-500/50 flex items-center gap-3">
                    ...
                    <span class="text-red-200">{{ $errors->first('social') }}</span>
                </div>
            @endif
            ...
            <div class="text-center mt-6">
                ...
                <a href="{{ route('register') }}" class="text-cyan-400 hover:text-cyan-300 font-semibold ml-1 transition">
                    Create one
                </a>
            </div>
        </div>
